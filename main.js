...
var LoadScript=function(url,callback,error)
{
	...
	js.setAttribute('src', "https://cdn.jsdelivr.net/gh/ozh/cookieclicker@gh-pages/" + url);
...
var Loader=function()//asset-loading system
{
	...
	this.Replace=function(old,newer)
	{
		...
		else img.src="https://cdn.jsdelivr.net/gh/ozh/cookieclicker@gh-pages/"+newer;
		img.alt=newer;
		img.onload=bind(this,this.onLoad);
		this.assets[old]=img;
	}
...
Game.resPath='https://cdn.jsdelivr.net/gh/ozh/cookieclicker@gh-pages/';
